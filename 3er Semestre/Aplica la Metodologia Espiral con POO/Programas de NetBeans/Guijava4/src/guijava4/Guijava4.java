 ...
 * @author PC-10
 */
public abstract class Guijava4 implements ActionListener
{
JButton bt1;//creando variables globales de los botones
     ...
     */ 
    public Guijava4(){//constructor de la clase 
    ...
    Guijava4 gj = new Guijava4() {};//uso de constructor para la ventana
    } 
