 ...
 * @author PC-10
 */
public abstract class Guijava3 implements ActionListener
{
JButton bt1;//creando variables globales de los botones
     ...
     */ 
    public Guijava3(){//constructor de la clase 
    ...
    Guijava3 gj = new Guijava3() {};//uso de constructor para la ventana
    } 
