 ...
 * @author PC-10
 */
public abstract class Guijava2 implements ActionListener
{
JButton bt1;//creando variables globales de los botones
     ...
     */ 
    public Guijava2(){//constructor de la clase 
    ...
    Guijava2 gj = new Guijava2() {};//uso de constructor para la ventana
    } 
